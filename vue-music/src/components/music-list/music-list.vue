<template>
   <div class="music-list">
     ...
     <scroll @scroll="scroll" :probe-type="probeType" :listen-scroll="listenScroll" :data="songs" class="list" ref="scroll">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.translateY = -this.bgImageHeight + TITLE_HEIGHT
    ...
    watch: {
      scrollY(newY) {
        let translateY = Math.max(this.translateY, newY)
        let zIndex = 0
        let scale = 1
